...
@Component({
  selector: 'lib-layout-stock-expiration',
  ...
  templateUrl: './layout-stock-expiration.html',
  styleUrl: './layout-stock-expiration.scss',
})
export class LayoutStockExpiration implements OnInit, OnDestroy {
  ...
  tableData() {
    ...
    [
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.STOCK.TABLE.HEADER.EXPIRATION.BAR_CODE'),
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.STOCK.TABLE.HEADER.EXPIRATION.LOCATION'),
        field: 'description', minWidth: 120, flex: 1,
        cellClass: 'ag_cell_center'
      },
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.STOCK.TABLE.HEADER.EXPIRATION.STATUS'),
