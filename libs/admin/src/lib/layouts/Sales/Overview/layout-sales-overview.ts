...
@Component({
  selector: 'lib-layout-sales-overview',
  ...
  templateUrl: './layout-sales-overview.html',
  styleUrl: './layout-sales-overview.scss',
})
export class LayoutSalesOverview implements OnInit, OnDestroy {
  ...
  tableData() {
    ...
    [
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.SALES.TABLE.HEADER.OVERVIEW.QTY_SOLD'),
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.SALES.TABLE.HEADER.OVERVIEW.TOTAL_SOLD'),
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.SALES.TABLE.HEADER.OVERVIEW.LAST_SOLD'),
        field: 'totalAmount', minWidth: 150, flex: 1,
        cellClass: 'ag_cell_end',
        cellRenderer: (params: ITableParams) => {
          return formatValue('', params.value);
