...
@Component({
  selector: 'lib-layout-sales-success',
  ...
  templateUrl: './layout-sales-success.html',
  styleUrl: './layout-sales-success.scss',
})
export class LayoutSalesSuccess implements OnInit, OnDestroy {
