...
@Component({
  selector: 'lib-layout-sales-cancelled',
  ...
  templateUrl: './layout-sales-cancelled.html',
  styleUrl: './layout-sales-cancelled.scss',
})
export class LayoutSalesCancelled implements OnInit, OnDestroy {
