...
import { CardPeopleCustomer } from "../../../components/_cards/people/customers/card-people-customer";

@Component({
  selector: 'lib-people-customers',
  imports: [RippleModule, TranslateModule, FloatLabelModule, FormsModule, InputIconModule, IconFieldModule, ReactiveFormsModule, InputTextModule, CardPeopleCustomer],
  templateUrl: './people-customers.html',
  styleUrl: './people-customers.scss',
})
export class PeopleCustomers implements OnInit, OnDestroy {
