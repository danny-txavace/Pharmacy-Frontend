...
@Component({
  selector: 'lib-financial-receipts',
...
export class FinancialReceipts implements OnInit, OnDestroy {
  ...
  tableData() {
    ...
    [
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.FINANCIAL.RECEIPTS.TABLE.HEADER.CUSTOMER'),
        field: 'description', minWidth: 200, flex: 1,
        cellClass: 'ag_cell_center'
      },
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.FINANCIAL.RECEIPTS.TABLE.HEADER.QTY'),
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.FINANCIAL.RECEIPTS.TABLE.HEADER.TOTAL'),
        field: 'totalAmount', minWidth: 150, flex: 1,
        cellClass: 'ag_cell_end',
        cellRenderer: (params: ITableParams) => {
          return formatValue('', params.value);
