...
@Component({
  ...
  templateUrl: './module-items.html',
  styleUrl: './module-items.scss',
})
export class ModuleItems implements OnInit, OnDestroy {
  ...
  tableData() {
    ...
    [
      ...
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.ITEMS.TABLE.HEADER.COMMERCIAL_NAME'),
        field: 'description', minWidth: 200, flex: 1,
        cellClass: 'ag_cell_center'
      },
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.ITEMS.TABLE.HEADER.ACTIVE_PRINCIPLE'),
        field: 'description', minWidth: 200, flex: 1,
        cellClass: 'ag_cell_center'
      },
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.ITEMS.TABLE.HEADER.PHARMACEUTICAL_FORM'),
        field: 'description', minWidth: 120, flex: 1,
        cellClass: 'ag_cell_center'
      },
      {
        headerName: this.translateService.instant('ADMIN.CENTRE.ITEMS.TABLE.HEADER.CATEGORY'),
        field: 'description', minWidth: 120, flex: 1,
        cellClass: 'ag_cell_center'
      }
    ];
